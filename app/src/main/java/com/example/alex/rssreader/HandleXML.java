        ...
        Thread thread = new Thread(new Runnable(){
            ...
            public void run() {
                ...
                try {
                    ...
                    conn.setRequestMethod("GET"); // What request method to use
                    ...
                    //create XMLPullParser object ,in order to create that, first create XmlPullParserFactory object and then call its newPullParser() method to create XMLPullParser.
